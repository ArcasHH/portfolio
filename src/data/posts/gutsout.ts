...
export const gutsoutPost: Post = {
  ...
  <details class="dev-details">
    ...
    <div class="dev-content">
      ...
      <h2>Developer's notes':</h2>
	    <p> The game on a stage of idea</p>
	    <img src="/portfolio/images/gutsout/other/GutsOut_notes.webp" alt="Notes" class="rounded-xl my-4" />
  ...
  `,
    ...
    contentRu: `
	  ...
	  <div class="dev-content">
	    ...
	    <ul>
         ...
         <li>
         Мы ушли от банальных алхимии, ритуалов и культистов в сторону идеи, что тело и душа связаны мистически. Перекладывая органы игрок проводит ритуал перенастройки души. 
         Сама идея «лечить заменой внутренностей» звучит антинаучно, а работа с органами всегда была частью тёмных практик (вскрытия, гадания на внутренностях, алхимия тела).
         </li>

 	     <li>Арт: ч/б, неаккуратный → «будто пациент мучил графический планшет». Также позы пациентов как в египетском искусстве: профиль головы и ног, фас корпуса. Будет ли вызыать ассоциации древнего загробного мира?</li>
 	     <li>Геймплей: менять органы местами чтобы лечить пациентов. Органы имеют характеристики в определенных эмоциях. Набор эмоции определяет болезнь, что отражено визуально во внешнем виде пациента. 
          Переставлением органов мы меняем эмоции и, как следствие, состояние болезни пациента. Нужно вычислить какие органы нужны пациенту по тому от чего меняется его внешний вид, издаваемые звуки. 
          (Спойлер: мы не успели и пришли к отображению численных параметров mind, soul, body. Но может оно и к лучшему - без явного отображения как влияют те или иные органы игра бы превратилась в угадайку).
		</li>
          ...
          <li>Сюжет: Мы оккультный доктор, который манипулирует душой людей через подбор нужных комбинаций органов. Но не всё так просто! У нас есть тяжело больная дочь, которой постоянно нужны новые органы чтобы выжить.
          Ситуацию услажняет то, что со временем ей нужны всё более качественные органы для сохранения её души. И способ только один - найти идеальных доноров.</li>
        ...
        <h2>Заметки разработчика:</h2>
	    <p> Как выглядел процессинг идеи и разработки</p>
 	   ...
 	   <ul>
         ...
         <li>Введена карма для фикса ножа. Теперь пациенты дают "валюту", за которую можно убивать пациентов. От кол-ва убийств записит цена</li>
	     <li>Больше кармы за несколько отпущенных пациентов за раз -> мотивация балансить </li>
 	     <li>Радостные залили билд за 2-3 часа. Начали впервые тестить и обнаружили баг с выпадением редких органов, из-за чего игра была непроходима. Начали судорожно фиксить костылями) Успели за 10 минут до окончания таймера!!!
          Были еще пару небольших багов. Что-то успели пофиксить, а что-то - нет. Есть над чем работать.</li>
 	   </ul>
	   ...
	   <ul>
	      ...
	      <li>Были баги, которые судорожно правили. Самое критичное успели исправить (или не всё?) и залить рабочий билд на 
		<a href="https://myindie.ru/games/game/gutsout" class="text-primary hover:text-primary/80 underline">MyIndie</a>.
	     </li>
	    </ul>
	...
	<details class="dev-details">
	  ...
	  <div class="dev-content">
	    <h2>Описание:</h2>
	    <p>В самом начале решили, что игра будет черно-белая, арт неаккуратный → «будто пациент мучил графический планшет». Из плюсов - скорость рисования, тк художник (я) занимался так же и кодом и другими вещами</p>
