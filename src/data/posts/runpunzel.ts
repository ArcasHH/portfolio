...
`,
    ...
    contentRu: `
      ...
      Игра состоит из нескольких уровней и в рамках каждого твоя задача пройти до выхода. Но не всё так просто! Тебе придется проделать это несколько раз и играя не только за принцессу, но и за призраков, чья цель - не дать принцессе пройти.
