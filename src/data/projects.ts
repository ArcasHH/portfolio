...
export const projects = [
  {
    title: 'AceAge',
    slug: 'aceage',
    techEn: ['Deck Building', 'Strategy', 'Turn-Based'],
    techRu: ['Deck Building', 'Strategy', 'Turn-Based'],
  ...
  },
  {
    title: 'GutsOut',
    slug: 'gutsout',
    techEn: ['Puzzle', 'Balancing', 'Turn-Based', 'Jam'],
    techRu: ['Puzzle', 'Balancing', 'Turn-Based', 'Jam'],
  ...
  },
  {
    title: 'RunPunzel',
    //slug: 'runpunzel',
    techEn: ['Puzzle', 'Top-Down', 'Turn-Based', 'Jam'],
    techRu: ['Puzzle', 'Top-Down', 'Turn-Based', 'Jam'],
  ...
  },
  {
    title: 'TangleJump',
    slug: 'tanglejump',
    techEn: ['Platformer', '2D','Jam'],
    techRu: ['Platformer', '2D','Jam'],
